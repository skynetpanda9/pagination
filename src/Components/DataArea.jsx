...
const DataArea = ({ data }) => {
  return (
    <div className='flex flex-col p-2 w-full items-center justify-center h-[70vh] relative bg-blue-400 rounded-md shadow-md mt-2'>
      ...
      <div className='bg-white flex w-full h-[62vh] mt-2 rounded-md border-none'>
        <div className='flex flex-col w-full overflow-x-scroll justify-between text-center p-4'>
          {data.map((tx) => {
            return (
              <ul
                key={tx.id}
